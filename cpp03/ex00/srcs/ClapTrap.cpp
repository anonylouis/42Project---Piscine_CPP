...
/*   Updated: 2022/04/11 01:07:56 by lcalvie          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::attack(const std::string& target)
{
	if (_energy && _hitpoints)
	{
		...
		std::cout << "ClapTrap " << _name << " need some reparations before attacking..." << std::endl;
	else
...
void ClapTrap::takeDamage(unsigned int amount)
{
	...
	{
		_hitpoints -= amount;
		std::cout << "ClapTrap " << _name << " take " << amount << " damage, has now " << _hitpoints << " hp !" << std::endl;
	}
	else
	{
		if (_hitpoints > 0)
			std::cout << "ClapTrap " << _name << " take " << amount << " damage, has now 0 hp and need to be repaired !" << std::endl;
		else
...
void ClapTrap::beRepaired(unsigned int amount)
{
	if (_energy)
	{
		...
		std::cout << "ClapTrap " << _name << " doesn't have the energy needed to be reapaired ..." << std::endl;
}
