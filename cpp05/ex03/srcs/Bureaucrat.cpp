...
/*   Updated: 2022/04/20 12:35:23 by lcalvie          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Bureaucrat::executeForm(Form const & form) const
{
	...
	{
		std::cout << _name << " can't execute the form "  << form.get_name() << std::endl;
		std::cout << e.what() << std::endl;
		return ;
	}
	std::cout << _name << " executed the form "  << form.get_name() << std::endl;
}